...
layout: post 
title:  "Fellowers"
subtitle: "A calm game"
date:   2018-10-01 21:11:24 +0000
categories: jekyll update
type: project

company: (Assignment) User Interface Design
...
<figure>
    <img src="/imgs/fellowers/paperwires.jpg" alt="">
    <img src="/imgs/fellowers/drafts.jpg" alt="">
    <figcaption><strong>Fig. 1</strong> Initial semi-interactive wireframe and early sketches of the character and backgrounds.</figcaption>
</figure>

The player should keep the flower alive and happy, by regularly performing a set of actions: watering, sheltering and also talking to it. The plant is very friendly, trustful and smart in order to provide a pleasant conversation with the player.
...
The main challenges of designing a game for older adults were:
- They are a diverse group of people: not everybody gets old at the same pace neither in the same way;
- The relationship and the feelings towards technology are also very different.

Our strategy was to keep things simple, and aimed to a minimalist design. It evolved to a game that presumes discovery, and we found creative freedom with it. In the end, this added a new challenge as it was hard to balance it with the game usability for the target audience. Testing was out of scope and we were out of time, but it could have helped finding this balance.
